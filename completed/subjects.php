                  ...
                  <div class="card-body d-flex flex-column">
                    <div class="wrapper">
                      ...
                      <div class="form-group">
                          ...
                          <select  style="border-radius: 10px; height: 40px"  disabled class="form-control" name="session">
                        ...
                        <div class="form-group">
                          ...
                          <select style="border-radius: 10px; height: 40px" class="form-control" name="class">
                            ...
                            <div class="form-group">
                              ...
                              <input style="border-radius: 10px; height: 40px" name="subject" class="form-control" type="text" placeholder="Subject Name">
                            </div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <select  style="border-radius: 10px; height: 40px"  class="form-control" name="schedule_day">
                          ...
                          <div class="col-md-5">
                            <div class="form-group">
                              ...
                              <input  style="border-radius: 10px; height: 40px"  class="form-control" type="time" name="schedule_time" id="">
                            </div>
                          </div>
                        ...
                        <div class="row">
                          <div class="col-md-11">
                            <div class="form-group">
                              ...
                              <input  style="border-radius: 10px; height: 40px"  class="form-control" type="text" name="" id="">
                            </div>
                          </div>
                      ...
                      <button type="submit" class="btn btn-inverse-success btn-sm" style="width: 100%; height: 40px; border-radius: 10px;">Generate
                        Assessment</button>
                    </div>
                  </div>
                </div>
