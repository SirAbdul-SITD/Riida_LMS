                  ...
                  <table class="table table-striped">
                    ...
                    foreach ($Subjects as $index => $Subject): ?>
                      <tr>
                        ...
                        <td>  <?= $Subject['topics_no']; ?> Topics </td>
                        <td>
                          <div class="progress">
                            <div class="progress-bar bg-danger" role="progressbar" style="width: <?= $Subject['progress']; ?>%"
                              aria-valuenow="<?= $Subject['progress']; ?>" aria-valuemin="0" aria-valuemax="100"></div>
                          </div>
                        </td>
                        <td>
                          <div class="row" style="justify-content: space-around;">
                            <button type="button" id="form_button" class="btn social-btn btn-rounded btn-social-outline-twitter" style="width: 30px; height: 30px; padding: 0%;">
