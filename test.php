                    ...
                    <div class="wrapper">
                      ...
                      <div>
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input style="border-radius: 10px; height: 40px" name="date" class="form-control" type="date">
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input style="border-radius: 10px; height: 40px" class="form-control" type="time" name="time">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <select style="border-radius: 10px; height: 40px" class="form-control" name="subject">
                            <option selected disabled> Select</option>
                            <?php
                        ...
                        <div class="row">
                          <div class="col-md-6">
                            <div class="form-group">
                              ...
                              <input style="border-radius: 10px; height: 40px" name="objective" class="form-control" type="number" placeholder="Objective Questions">
                            </div>
                          </div>
                          ...
                          <div class="col-md-6">
                            <div class="form-group">
                              <label for="time"></label>
                              <input style="border-radius: 10px; height: 40px" class="form-control" type="number" name="essay" placeholder="Essay Questions">
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <textarea style="border-radius: 10px;" class="form-control" id="focus" name="focus" rows="3"
                            placeholder="Generate questions from ... topics"></textarea>
                        </div>

                      </div>
                      <button type="submit" class="btn btn-inverse-success btn-sm" style="width: 100%">Generate
                        Assessment</button>
                    </div>
                  </div>
                </div>
