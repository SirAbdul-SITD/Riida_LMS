...
<head>
  ...
  <title>Edit Assessment | Riida LMS
  </title>
  <!-- plugins:css -->
                ...
                <div class="card">
                  <div class="card-body col-md-12 align-self-center">
                    <div class=" align-content-start">
                      ...
                      <div>
                        <div class="form-group">
                          <label for="exampleTextarea1">Edit assessment questions, you can copy paste and edit AI
                            generated content below</label>
                          <textarea style="border-radius: 10px;" class="form-control" id="exampleTextarea1" name="material" rows="30"></textarea>
                        </div>
                ...
                <div class="card">
                  <div class="card-body d-flex flex-column">
                    <div class="wrapper">
                      ...
                      <button type="submit" class="btn btn-inverse-success btn-sm" style="width: 100%">Re-Generate
                        Assessment</button>
                    </div>
                  </div>
                </div>
